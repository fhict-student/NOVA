<script>
	...
	const bewoners = [
		{ name: 'Arjen', href: '/' + 'arjen', help: 'Zoon, 16', logo: '/arjen/profielfoto.png' },
		{ name: 'Marie', href: '/' + 'marie', help: 'Moeder, 47', logo: '/marie/profielfoto.png' },
		{
			name: 'Helena',
			href: '/' + 'helena',
			help: 'Grootmoeder, 73',
			logo: '/helena/profielfoto.png'
		}
	];
</script>
...
<Navbar class="fixed bg-background-light p-0 dark:bg-background-dark">
	...
	<NavUl>
		<!-- HOME -->
		<NavLi href="/" class="flex select-none gap-2"
			><Img src="favicon.png" imgClass="size-5" alt="icon" />Home</NavLi
		>
